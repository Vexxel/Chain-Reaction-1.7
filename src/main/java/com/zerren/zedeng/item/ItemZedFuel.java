...
import zedeng.api.item.IRadioactiveMaterial;
import zedeng.api.item.ISolidReactorFuel;
 ...
 */
public class ItemZedFuel extends ItemZE implements ISolidReactorFuel, IRadioactiveMaterial {
