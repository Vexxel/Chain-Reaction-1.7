package com.zerren.zedeng.client.render;
...
/**
 * Created by Zerren on 3/2/2015.
 */
public class RenderCustomStarfield
{
    ...
    public RenderCustomStarfield(double y, double x1, double x2, double z1, double z2)
    {
        surfaceY = y;
        surfaceX1 = x1;
        surfaceX2 = x2;
