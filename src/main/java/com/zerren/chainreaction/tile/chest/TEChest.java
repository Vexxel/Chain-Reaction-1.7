package com.zerren.chainreaction.tile.chest;
...
import com.zerren.chainreaction.handler.network.client.tile.MessageTileChest;
 ...
 */
public class TEChest extends TileEntityCRBase implements IInventory
{
    /**
    ...
    public TEChest(int metaData) {
        ...
        if (metaData == 0) {
            inventory = new ItemStack[ContainerChestCR.BRICK_ROWS * ContainerChestCR.BRICK_COLUMNS];
        }
        else if (metaData == 1) {
            inventory = new ItemStack[ContainerChestCR.THAUMIUM_ROWS * ContainerChestCR.THAUMIUM_COLUMNS];
        }
        else if (metaData == 2) {
            inventory = new ItemStack[ContainerChestCR.VOID_ROWS * ContainerChestCR.VOID_COLUMNS];
        }
    }
    ...
    public void openInventory() {
        ++numUsingPlayers;
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, CRBlocks.chest, 1, numUsingPlayers);
    }
    ...
    public Packet getDescriptionPacket() {
        return PacketHandler.INSTANCE.getPacketFrom(new MessageTileChest(this, getChestLocked()));
    }
}
