 ...
 */
public class BlockFluidGasBase extends BlockFluidCR {

    public BlockFluidGasBase(Fluid fluid, Material material, String name, int quanta, int tickr, float hardness, int lightOpacity) {
