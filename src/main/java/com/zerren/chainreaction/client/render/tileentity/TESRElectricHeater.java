...
public class TESRElectricHeater extends TileEntitySpecialRenderer {

    private final ModelElectricHeater model = new ModelElectricHeater();
    ...
    private void renderTank(TileEntity tile, double x, double y, double z) {
        if (tile instanceof TEElectricHeater) {
            TEElectricHeater rtg = (TEElectricHeater) tile;
            ...
            this.bindTexture(Reference.Textures.Models.ELECTRIC_HEATER);
            model.render();
