...
public class TESRStirlingEngine extends TileEntitySpecialRenderer {

    private final ModelStirlingEngine modelStirlingEngine = new ModelStirlingEngine();
    ...
    private void renderTank(TileEntity tile, double x, double y, double z) {
        if (tile instanceof TEStirlingEngine) {
            TEStirlingEngine rtg = (TEStirlingEngine) tile;
            ...
            this.bindTexture(Reference.Textures.Models.STIRLING_ENGINE);
            modelStirlingEngine.render();
