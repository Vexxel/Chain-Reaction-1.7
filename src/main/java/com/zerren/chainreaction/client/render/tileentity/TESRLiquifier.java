...
import com.zerren.chainreaction.client.render.model.ModelLiquifier;
...
public class TESRLiquifier extends TileEntitySpecialRenderer {
    ...
    private void renderTank(TileEntity tile, double x, double y, double z) {
        if (tile instanceof TELiquifier) {
            TELiquifier rtg = (TELiquifier) tile;
            ...
            this.bindTexture(Reference.Textures.Models.LIQUIFIER);
            model.render();
