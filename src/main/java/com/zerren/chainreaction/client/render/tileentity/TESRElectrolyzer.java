...
import com.zerren.chainreaction.client.render.model.ModelElectrolyzer;
...
public class TESRElectrolyzer extends TileEntitySpecialRenderer {

    private final ModelElectrolyzer model = new ModelElectrolyzer();
    ...
    private void renderTank(TileEntity tile, double x, double y, double z) {
        if (tile instanceof TEElectrolyzer) {
            TEElectrolyzer rtg = (TEElectrolyzer) tile;
            ...
            this.bindTexture(Reference.Textures.Models.ELECTROLYZER);
            model.render();
